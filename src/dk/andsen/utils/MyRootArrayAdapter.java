...
public class MyRootArrayAdapter extends ArrayAdapter<String> {
	 ...
	 */
	public MyRootArrayAdapter(Activity context, List<String> names, String[] filtetypes) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		int nl = s.indexOf("\n");
		String dir = s.substring(nl + 1, nl + 2);

		if (dir.equals("d") || s.equals(".."))  {
